...
const DentalRecordForm: React.FC<DentalRecordFormProps> = ({
  onSubmit,
  onClose,
  isSubmitting = false,
  patient,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (
      ...
      alert(
        'Mohon lengkapi semua field: Nomor Gigi, Tanggal, Jenis Perawatan, dan Deskripsi.'
      );
      return;
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        ...
        {availableTeeth.length === 0 && (
          <p className="text-xs text-red-500 mt-1">
            Tidak ada gigi yang dapat dipilih untuk pasien ini.
          </p>
        )}
      </div>
      ...
      <div className="flex justify-end space-x-3 pt-3">
        ...
        <button
          type="submit"
          disabled={isSubmitting || patient.teeth.length === 0}
